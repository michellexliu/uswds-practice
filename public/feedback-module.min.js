...
var iterableToArrayLimit = __webpack_require__(55);
...
var _IconInner = _interopRequireDefault(__webpack_require__(60));
...
axios.spread = __webpack_require__(52); // Expose isAxiosError
...
var _icons = _interopRequireDefault(__webpack_require__(61));
...
// CONCATENATED MODULE: ./src/translations/en/translation.js
var TRANSLATIONS_EN={submitBtn:"Submit",feedbackType:{title:"Do you have any feedback on {{page}}?"},missing:{initialBtn:"I couldn't find what I was looking for",title:"Sorry you couldn't find what you were looking for! Can you tell us a little more?",checkboxes:["I wasn't sure where to look","I was confused by the information I found","I don't understand how to use this website","I hit a dead end","The content was not available in my preferred language","There were errors with the translation available","Other"],textInputs:[{type:"textarea",text:"What were you looking for or trying to do?"},{type:"textarea",text:"Would you like to add anything else?"}]},broken:{initialBtn:"Something appears to be broken or inaccurate",title:"Sorry to hear that something is broken or inaccurate! Can you tell us a little more?",checkboxes:["There is a spelling mistake or typo","A link or button does not work","The information is out of date","I got different information from another source (311, printed mailer, elected official, etc.)","The layout looks broken","I got an error","Other"],textInputs:[{type:"textarea",text:"Can you give us more details on what you were trying to do, or the exact problem you encountered?"}]},other:{initialBtn:"I have other feedback on this page or website",title:"We appreciate your feedback.",textInputs:[{type:"textarea",text:"Can you tell us a little more?",required:true}]},feedbackResults:{title:"Thank you for your feedback! It has been submitted.<br /><br />Your feedback is anonymous and confidential, so you will not receive a reply.",plainText:"<p>The City of New York is always trying to improve its services. Are you interesed in being a user research participant? This is is entirely voluntary and you can opt out at any time. Signing up to be a user research participant will have no impact on your feedback today, or your eligibility to access or receive services in the future.</p>",button:"Yes, sign me up!"},userResearch:{title:"As a user research participant you can help us continue to improve services for New Yorkers",plainText:'<p>Please leave your contact details and we will get in touch with you. Being a research participant means you may be contacted from time to time to help us test new services and products. We will send you an email with more details.</p><p class="padding-top-2">You can opt out at any time.</p>',textInputs:[{type:"text",text:"Your name",required:true},{type:"email",text:"Your email",required:true},{type:"tel",text:"Your phone number"}]},userFeedbackResults:{title:"Thank you for signing up to be a user research participant!  We’ll be in touch if there are any opportunities to test products and services."},errorMessages:{checkboxError:"Please select at least one option.",nameError:"Please provide your name.",emailError:"Please provide a valid email address.",phoneError:"This is an invalid phone number. We only accept US numbers at the moment.",inputEmptyError:"Please provide a response."}};
// CONCATENATED MODULE: ./src/translations/es/translation.js
var TRANSLATIONS_ES={submitBtn:"[es] Submit",feedbackType:{title:"[es] Do you have any feedback on {{page}}?"},missing:{initialBtn:"[es] I couldn't find what I was looking for",title:"[es] Sorry you couldn't find what you were looking for! Can you tell us a little more?",checkboxes:["[es] I wasn't sure where to look","[es] I was confused by the information I found","[es] I don't understand how to use this website","[es] I hit a dead end","[es] The content was not available in my preferred language","[es] There were errors with the translation available","[es] Other"],textInputs:[{type:"textarea",text:"[es] What were you looking for or trying to do?"},{type:"textarea",text:"[es] Would you like to add anything else?"}]},broken:{initialBtn:"[es] Something appears to be broken or inaccurate",title:"[es] Sorry to hear that something is broken or inaccurate! Can you tell us a little more?",checkboxes:["[es] There is a spelling mistake or typo","[es] A link or button does not work","[es] The information is out of date","[es] I got different information from another source (311, printed mailer, elected official, etc.)","[es] The layout looks broken","[es] I got an error","[es] Other"],textInputs:[{type:"textarea",text:"[es] Can you give us more details on what you were trying to do, or the exact problem you encountered?"}]},other:{initialBtn:"[es] I have other feedback on this page or website",title:"[es] We appreciate your feedback.",textInputs:[{type:"textarea",text:"[es] Can you tell us a little more?",required:true}]},feedbackResults:{title:"[es] Thank you for your feedback! It has been submitted.<br /><br />Your feedback is anonymous and confidential, so you will not receive a reply.",plainText:"<p>[es] The City of New York is always trying to improve its services. Are you interesed in being a user research participant? This is is entirely voluntary and you can opt out at any time. Signing up to be a user research participant will have no impact on your feedback today, or your eligibility to access or receive services in the future.</p>",button:"[es] Yes, sign me up!"},userResearch:{title:"[es] As a user research participant you can help us continue to improve services for New Yorkers",plainText:'<p>[es] Please leave your contact details and we will get in touch with you. Being a research participant means you may be contacted from time to time to help us test new services and products. We will send you an email with more details.</p><p class="padding-top-2">You can opt out at any time.</p>',textInputs:[{type:"text",text:"[es] Your name",required:true},{type:"email",text:"[es] Your email",required:true},{type:"tel",text:"[es] Your phone number"}]},userFeedbackResults:{title:"[es] Thank you for signing up to be a user research participant!  We’ll be in touch if there are any opportunities to test products and services."},errorMessages:{checkboxError:"[es] Please select at least one option.",nameError:"[es] Please provide your name.",emailError:"[es] Please provide a valid email address.",phoneError:"[es] This is an invalid phone number.",inputEmptyError:"[es] Please provide a response."}};
// CONCATENATED MODULE: ./src/translations/ar/translation.js
var TRANSLATIONS_AR={submitBtn:"[ar] Submit",feedbackType:{title:"[ar] Do you have any feedback on {{page}}?"},missing:{initialBtn:"[ar] I couldn't find what I was looking for",title:"[ar] Sorry you couldn't find what you were looking for! Can you tell us a little more?",checkboxes:["[ar] I wasn't sure where to look","[ar] I was confused by the information I found","[ar] I don't understand how to use this website","[ar] I hit a dead end","[ar] The content was not available in my preferred language","[ar] There were errors with the translation available","[ar] Other"],textInputs:[{type:"textarea",text:"[ar] What were you looking for or trying to do?"},{type:"textarea",text:"[ar] Would you like to add anything else?"}]},broken:{initialBtn:"[ar] Something appears to be broken or inaccurate",title:"[ar] Sorry to hear that something is broken or inaccurate! Can you tell us a little more?",checkboxes:["[ar] There is a spelling mistake or typo","[ar] A link or button does not work","[ar] The information is out of date","[ar] I got different information from another source (311, printed mailer, elected official, etc.)","[ar] The layout looks broken","[ar] I got an error","[ar] Other"],textInputs:[{type:"textarea",text:"[ar] Can you give us more details on what you were trying to do, or the exact problem you encountered?"}]},other:{initialBtn:"[ar] I have other feedback on this page or website",title:"[ar] We appreciate your feedback.",textInputs:[{type:"textarea",text:"[ar] Can you tell us a little more?",required:true}]},feedbackResults:{title:"[ar] Thank you for your feedback! It has been submitted.<br /><br />Your feedback is anonymous and confidential, so you will not receive a reply.",plainText:"<p>[ar] The City of New York is always trying to improve its services. Are you interesed in being a user research participant? This is is entirely voluntary and you can opt out at any time. Signing up to be a user research participant will have no impact on your feedback today, or your eligibility to access or receive services in the future.</p>",button:"[ar] Yes, sign me up!"},userResearch:{title:"[ar] As a user research participant you can help us continue to improve services for New Yorkers",plainText:'<p>[ar] Please leave your contact details and we will get in touch with you. Being a research participant means you may be contacted from time to time to help us test new services and products. We will send you an email with more details.</p><p class="padding-top-2">You can opt out at any time.</p>',textInputs:[{type:"text",text:"[ar] Your name",required:true},{type:"email",text:"[ar] Your email",required:true},{type:"tel",text:"[ar] Your phone number"}]},userFeedbackResults:{title:"[ar] Thank you for signing up to be a user research participant!  We’ll be in touch if there are any opportunities to test products and services."},errorMessages:{checkboxError:"[ar] Please select at least one option.",nameError:"[ar] Please provide your name.",emailError:"[ar] Please provide a valid email address.",phoneError:"[ar] This is an invalid phone number.",inputEmptyError:"[ar] Please provide a response."}};
// CONCATENATED MODULE: ./src/i18n.js
esm_i18next// detect user language
// learn more: https://github.com/i18next/i18next-browser-languageDetector
.use(i18nextBrowserLanguageDetector)// pass the i18n instance to react-i18next.
.use(initReactI18next)// init i18next
// for all options read: https://www.i18next.com/overview/configuration-options
.init({resources:{en:{translation:TRANSLATIONS_EN},es:{translation:TRANSLATIONS_ES},ar:{translation:TRANSLATIONS_AR}},debug:true,fallbackLng:"en",interpolation:{escapeValue:false// not needed for react as it escapes by default
...
function index_module_a() {
  return (index_module_a = Object.assign || function (e) {
...
var u = {
  ...
  tabindex: "tabIndex"
    ...
    index_module_f = Object.keys(index_module_p).reduce(function (e, t) {
  return e[index_module_p[t]] = t, e;
}, {}),
    d = function d(e, t) {
  ...
  return Array.isArray(e) ? e.join("") : e;
    ...
    index_module_v = [u.NOSCRIPT, u.SCRIPT, u.STYLE],
    A = function A(e, t) {
  ...
  return void 0 === t && (t = {}), Object.keys(e).reduce(function (t, r) {
    return t[index_module_p[r] || r] = e[r], t;
  }, t);
},
    index_module_E = function E(t, r, n) {
  switch (t) {
    case u.TITLE:
      return {
        toComponent: function toComponent() {
          return n = r.titleAttributes, (i = {
            key: t = r.title
          })["data-rh"] = !0, o = O(n, i), [react_default.a.createElement(u.TITLE, o, t)];
          var t, n, i, o;
        },
  ...
  var t = e.bodyAttributes,
      ...
      f = e.titleAttributes;
  return {
    base: index_module_E(u.BASE, e.baseTag, r),
    bodyAttributes: index_module_E("bodyAttributes", t, r),
    htmlAttributes: index_module_E("htmlAttributes", n, r),
    link: index_module_E(u.LINK, i, r),
    meta: index_module_E(u.META, o, r),
    noscript: index_module_E(u.NOSCRIPT, a, r),
    script: index_module_E(u.SCRIPT, s, r),
    style: index_module_E(u.STYLE, c, r),
    title: index_module_E(u.TITLE, {
      title: p,
      titleAttributes: f
    }, r)
  };
},
    I = react_default.a.createContext({}),
    P = prop_types_default.a.shape({
  setHelmet: prop_types_default.a.func,
  helmetInstances: prop_types_default.a.shape({
    get: prop_types_default.a.func,
    add: prop_types_default.a.func,
  ...
  return index_module_s(r, t), r.prototype.render = function () {
    return react_default.a.createElement(I.Provider, {
      value: this.value
    }, this.props.children);
  }, r;
}(react["Component"]);
...
x.canUseDOM = L, x.propTypes = {
  context: prop_types_default.a.shape({
    helmet: prop_types_default.a.shape()
  }),
...
var j = function j(e, t) {
  ...
  return r.shouldComponentUpdate = function (e) {
    return !shallowequal_default()(e, this.props);
    ...
    var e,
      ...
      onChangeClientState: index_module_m(e),
      scriptTags: b(u.SCRIPT, ["src", "innerHTML"], e),
      styleTags: b(u.STYLE, ["cssText"], e),
      title: h(e),
      titleAttributes: y("titleAttributes", e)
    });
    x.canUseDOM ? (t = o, index_module_k && cancelAnimationFrame(index_module_k), t.defer ? index_module_k = requestAnimationFrame(function () {
      H(t, function () {
        index_module_k = null;
      });
    }) : (H(t), index_module_k = null)) : S && (i = S(o)), n(i);
  }, r.init = function () {
...
var N = function (t) {
  ...
  return o.shouldComponentUpdate = function (e) {
    return !react_fast_compare_default()(this.props, e);
    ...
    return index_module_a({}, n, ((t = {})[r.type] = [].concat(n[r.type] || [], [index_module_a({}, e.newChildProps, this.mapNestedChildrenToProps(r, e.nestedChildren))]), t));
    ...
    switch (n.type) {
      case u.TITLE:
        return index_module_a({}, i, ((t = {})[n.type] = s, t.titleAttributes = index_module_a({}, o), t));

      case u.BODY:
        return index_module_a({}, i, {
          bodyAttributes: index_module_a({}, o)
        });

      case u.HTML:
        return index_module_a({}, i, {
          htmlAttributes: index_module_a({}, o)
        });

      default:
        return index_module_a({}, i, ((r = {})[n.type] = index_module_a({}, o), r));
    }
  }, o.mapArrayTypeChildrenToProps = function (e, t) {
    var r = index_module_a({}, t);
    return Object.keys(e).forEach(function (t) {
      var n;
      r = index_module_a({}, r, ((n = {})[t] = e[t], n));
    }), r;
  }, o.warnOnInvalidChildren = function (e, t) {
    return browser_default()(l.some(function (t) {
      return e.type === t;
    }), "function" == typeof e.type ? "You may be attempting to nest <Helmet> components within each other, which is not allowed. Refer to our API for more information." : "Only elements types " + l.join(", ") + " are allowed. Helmet does not support rendering <" + e.type + "> elements. Refer to our API for more information."), browser_default()(!t || "string" == typeof t || Array.isArray(t) && !t.some(function (e) {
    ...
    var n = this,
        i = {};
    return react_default.a.Children.forEach(t, function (e) {
      if (e && e.props) {
        var t = e.props,
            o = t.children,
            a = index_module_c(t, ["children"]),
            s = Object.keys(a).reduce(function (e, t) {
          return e[index_module_f[t] || t] = a[t], e;
        }, {}),
            l = e.type;
    ...
    var t = this.props,
        r = t.children,
        n = index_module_a({}, index_module_c(t, ["children"]));
    return r && (n = this.mapChildrenToProps(r, n)), react_default.a.createElement(I.Consumer, null, function (t) {
      return react_default.a.createElement(M, index_module_a({}, n, {
        context: t
      }));
    });
  }, r;
...
var react_uswds_lib = __webpack_require__(3);

// CONCATENATED MODULE: ./src/lib/constants.js
var SCREENS={feedback_type:{title:"feedbackType.title",buttons:[{type:"form",text:"missing.initialBtn",nextScreen:"missing_info",feedbackID:"data1"},{type:"form",text:"broken.initialBtn",nextScreen:"broken",feedbackID:"data2"},{type:"form",text:"other.initialBtn",nextScreen:"other",feedbackID:"data3"}]},missing_info:{title:"missing.title",checkboxes:{labels:"missing.checkboxes",required:true},textInputs:"missing.textInputs",formID:"feedback",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},broken:{title:"broken.title",checkboxes:{labels:"broken.checkboxes",required:true},textInputs:"broken.textInputs",formID:"feedback",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},other:{title:"other.title",textInputs:"other.textInputs",formID:"feedback",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},feedback_results:{titleInverse:"feedbackResults.title",plainText:"feedbackResults.plainText",buttons:[{type:"submit",text:"feedbackResults.button",nextScreen:"user_research"}]},user_research:{title:"userResearch.title",plainText:"userResearch.plainText",textInputs:"userResearch.textInputs",formID:"research",buttons:[{type:"submit",text:"submitBtn",nextScreen:"user_feedback_result"}]},user_feedback_result:{titleInverse:"userFeedbackResults.title"}};var INITIAL_SCREEN=SCREENS.feedback_type;
// EXTERNAL MODULE: ./node_modules/axios/index.js
var axios = __webpack_require__(24);
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);

// CONCATENATED MODULE: ./src/services/requestService.js
var requestService_requestService=function requestService(apiEndpoint,obj){axios_default.a.post("".concat("https://ctofeedback.azurewebsites.net","/api/").concat(apiEndpoint),obj).then(function(res){return console.log(res);}).catch(function(err){return console.log(err);});};/* harmony default export */ var services_requestService = (requestService_requestService);
...
// CONCATENATED MODULE: ./node_modules/ga-4-react/dist/ga-4-react.esm.js
...
var ga_4_react_esm_GA4React = /*#__PURE__*/function () {
  function GA4React(gaCode, gaConfig, additionalGaCode, timeout, options) {
    classCallCheck_classCallCheck(this, GA4React);
  ...
  createClass_createClass(GA4React, [{
    key: "outputOnResolve",
    value: function outputOnResolve() {
      return {
    ...
    value: function initialize() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var previousScriptAsync = document.getElementById(_this.scriptAsyncId);
        ...
        scriptAsync.setAttribute('id', _this.scriptAsyncId);
        scriptAsync.setAttribute('async', '');

        if (_this.nonceAsync && typeof _this.nonceAsync === 'string' && _this.nonceAsync.length > 0) {
          scriptAsync.setAttribute('nonce', _this.nonceAsync);
        }

        scriptAsync.setAttribute('src', "https://www.googletagmanager.com/gtag/js?id=" + _this.gaCode);

        scriptAsync.onload = function () {
          var target = document.getElementById(_this.scriptSyncId);
          ...
          var previousScriptSync = document.getElementById(_this.scriptSyncId);
          ...
          scriptSync.setAttribute('id', _this.scriptSyncId);

          if (_this.nonceSync && typeof _this.nonceSync === 'string' && _this.nonceSync.length > 0) {
            scriptSync.setAttribute('nonce', _this.nonceSync);
          }

          var scriptHTML = "window.dataLayer = window.dataLayer || [];\n        function gtag(){dataLayer.push(arguments);};\n        gtag('js', new Date());\n        gtag('config', '" + _this.gaCode + "', " + JSON.stringify(_this.gaConfig) + ");";

          if (_this.additionalGaCode) {
            _this.additionalGaCode.forEach(function (code) {
              scriptHTML += "\ngtag('config', '" + code + "', " + JSON.stringify(_this.gaConfig) + ");";
            });
          }
          ...
          var resolved = _this.outputOnResolve();

          Object.assign(window, defineProperty_defineProperty({}, GA4ReactGlobalIndex, resolved));
          resolve(resolved);
        };

        scriptAsync.onerror = function (event) {
        ...
        var onChangeReadyState = function onChangeReadyState() {
    ...
    key: "pageview",
    value: function pageview(path, location, title) {
    ...
    key: "event",
    value: function event(action, label, category, nonInteraction) {
    ...
    value: function gtag() {
      ...
      //@ts-ignore
      return (_window = window).gtag.apply(_window, arguments);
    }
    /**
...
var ga_4_react_esm_outputGA4 = function outputGA4(children, setComponents, ga4) {
  setComponents(react_default.a.Children.map(children, function (child, index) {
    if (!react_default.a.isValidElement(child)) {
      return react_default.a.createElement(react_default.a.Fragment, null, child);
    } //@ts-ignore
...
var ga_4_react_esm_GA4R = function GA4R(_ref) {
  var code = _ref.code,
      timeout = _ref.timeout,
      config = _ref.config,
      additionalCode = _ref.additionalCode,
  ...
  Object(react["useEffect"])(function () {
    if (!ga_4_react_esm_GA4React.isInitialized()) {
      var ga4manager = new ga_4_react_esm_GA4React("" + code, config, additionalCode, timeout, options);
      ga4manager.initialize().then(function (ga4) {
        ga_4_react_esm_outputGA4(children, setComponents, ga4);
      }, function (err) {
        console.error(err);
      });
    } else {
      var ga4 = ga_4_react_esm_GA4React.getGA4React();
  ...
  return react_default.a.createElement(react_default.a.Fragment, null, components);
};

var ga_4_react_esm_useGA4React = function useGA4React(gaCode, gaConfig, gaAdditionalCode, gaTimeout, options) {
  ...
  Object(react["useEffect"])(function () {
    if (gaCode) {
      switch (ga_4_react_esm_GA4React.isInitialized()) {
        case false:
          var ga4react = new ga_4_react_esm_GA4React("" + gaCode, gaConfig, gaAdditionalCode, gaTimeout, options);
          ga4react.initialize().then(function (ga4) {
            setGA4(ga4);
          }, function (err) {
            console.error(err);
          });
        ...
        case true:
          setGA4(ga_4_react_esm_GA4React.getGA4React());
          break;
      }
    } else {
      setGA4(ga_4_react_esm_GA4React.getGA4React());
...
function withTracker(MyComponent) {
  return function (props) {
    var path = props.path,
        ...
        title = props.title,
        gaCode = props.gaCode,
        gaTimeout = props.gaTimeout,
        gaConfig = props.gaConfig,
        gaAdditionalCode = props.gaAdditionalCode,
    ...
    return react_default.a.createElement(MyComponent, Object.assign({}, props));
  };
}

/* harmony default export */ var ga_4_react_esm = (ga_4_react_esm_GA4React);

// CONCATENATED MODULE: ./src/lib/hooks/googleAnalytics.js
function googleAnalytics(){var ga=ga_4_react_esm_useGA4React();var trackFutureResearch=function trackFutureResearch(){ga&&ga.event("future_research","user agreed to participate in research in the future");};var pageTitleAsScreen=function pageTitleAsScreen(screenTitle){ga&&ga.pageview(window.location.pathname,window.location,screenTitle);};var pageChange=function pageChange(currentPage,nextPage){ga&&ga.gtag("event","page_change",{current_page_title:currentPage,next_page:nextPage});};var userViewedModule=function userViewedModule(){ga&&ga.event("module_viewed","module appeared on user screen");};var moduleOnScreen=function moduleOnScreen(ref){var _useState=Object(react["useState"])(false),_useState2=_slicedToArray(_useState,2),isIntersecting=_useState2[0],setIntersecting=_useState2[1];var _useState3=Object(react["useState"])(false),_useState4=_slicedToArray(_useState3,2),userViewed=_useState4[0],setUserViewed=_useState4[1];var checkVisible=function checkVisible(){if(!userViewed&&isIntersecting){console.log("module in view");setUserViewed(true);userViewedModule();}};var observer=new IntersectionObserver(function(_ref){var _ref2=_slicedToArray(_ref,1),entry=_ref2[0];return setIntersecting(entry.isIntersecting);},checkVisible());Object(react["useEffect"])(function(){observer.observe(ref.current);// Remove the observer as soon as the component is unmounted
return function(){observer.disconnect();};},[]);};return{trackFutureResearch:trackFutureResearch,pageTitleAsScreen:pageTitleAsScreen,pageChange:pageChange,moduleOnScreen:moduleOnScreen};}
// CONCATENATED MODULE: ./src/lib/hooks/useCheckboxes.js
/**
 ...
 * @returns {Object}
 */function useCheckboxes(){var initialFields=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;var initialOther=arguments.length>1&&arguments[1]!==undefined?arguments[1]:"";var _useTranslation=useTranslation(),t=_useTranslation.t,i18n=_useTranslation.i18n;var en=i18n.getFixedT("en");var _useState=Object(react["useState"])(initialFields),_useState2=_slicedToArray(_useState,2),checkedFields=_useState2[0],setCheckedFields=_useState2[1];var _useState3=Object(react["useState"])(initialOther),_useState4=_slicedToArray(_useState3,2),otherField=_useState4[0],setOtherField=_useState4[1];var onCheck=function onCheck(index){var checked=checkedFields;checked[index].checked=!checked[index].checked;setCheckedFields(checked);};// sets new checkboxes upon screen change, if there are any
var newScreenCheckboxes=function newScreenCheckboxes(checkboxes){checkboxes&&t(checkboxes.labels)&&setCheckedFields(en(checkboxes.labels).map(function(label){return{label:label,checked:false};}));};// checks if at least one checkbox was checked - returns true if yes false if no
var checkboxValidated=function checkboxValidated(){return checkedFields.some(function(field){return field.checked;});};// updates the other field's label
var updateOtherField=function updateOtherField(){if(checkedFields){checkedFields.forEach(function(field){field.label==="Other"&&field.checked&&(field.label="Other: ".concat(otherField));});setCheckedFields(checkedFields);}};return{checkedFields:checkedFields,onCheck:onCheck,newScreenCheckboxes:newScreenCheckboxes,checkboxValidated:checkboxValidated,updateOtherField:updateOtherField,setOtherField:setOtherField};}
...
// CONCATENATED MODULE: ./node_modules/babel-preset-react-app/node_modules/@babel/runtime/helpers/esm/wrapRegExp.js
...
function _wrapRegExp(re, groups) {
  ...
  inherits_inherits(BabelRegExp, _RegExp);
  ...
  BabelRegExp.prototype[Symbol.replace] = function (str, substitution) {
    if (typeof substitution === "string") {
      ...
      return _super[Symbol.replace].call(this, str, function () {
        ...
        if (typeof_typeof(args[args.length - 1]) !== "object") {
...
// CONCATENATED MODULE: ./src/lib/utils/textboxUtil.js
//Check if valid email address
var invalidEmail=function invalidEmail(email,required){var re=/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/;if(!required&&email===""){return false;}return!re.test(email);};var textboxUtil_invalidPhone=function invalidPhone(phone,required){var reUS=/*#__PURE__*/_wrapRegExp(/^[\0-\/:-@\[-\^`\{-\uFFFF]?[0-9]*?[\0-\/:-@\[-\^`\{-\uFFFF]*?([0-9]{3})[\0-\/:-@\[-\^`\{-\uFFFF]*?([0-9]{3})[\0-\/:-@\[-\^`\{-\uFFFF]*?([0-9]{4})[\0-\/:-@\[-\^`\{-\uFFFF]*?$/,{area:1,group1:2,group2:3});//Commenting this out because probably won't accept interntional phone numbers
//But keeping just in case:
// const reInternational = /^\+(?:[0-9] ?){6,14}[0-9]$/;
if(!required&&phone===""){return false;}return!reUS.test(phone);};var flattenInputs=function flattenInputs(inputQuestions){return inputQuestions?inputQuestions.map(function(_ref){var question=_ref.question,answer=_ref.answer;return{question:question,answer:answer};}):[];};
// CONCATENATED MODULE: ./src/lib/hooks/useInputs.js
/**
 ...
 * @returns {Object}
 */function useInputs(firstCheckRef){var _useTranslation=useTranslation(),t=_useTranslation.t,i18n=_useTranslation.i18n;var en=i18n.getFixedT("en");var _useState=Object(react["useState"])(null),_useState2=_slicedToArray(_useState,2),inputQuestions=_useState2[0],setInputQuestions=_useState2[1];var _useState3=Object(react["useState"])([]),_useState4=_slicedToArray(_useState3,2),inputRefs=_useState4[0],setInputRefs=_useState4[1];/* On a new screen, if there are no checkboxes & at least 1 input,
   * the first input is focused */Object(react["useEffect"])(function(){if(!firstCheckRef.current&&inputRefs.length>0){inputRefs[0].current.focus();}},[inputRefs]);// initializes new input values and refs upon screen change, if there are any
var newScreenInputs=function newScreenInputs(textInputs){var refList=[];// Updates the text inputs based on the new screen
t(textInputs)&&setInputQuestions(en(textInputs).map(function(question){refList.push(/*#__PURE__*/Object(react["createRef"])(null));return{question:question.text,answer:"",required:question.required,error:false,type:question.type};}));setInputRefs(refList);};//Checks if all the required fields have been completed - returns true if yes false if no
var inputsValidated=function inputsValidated(){var validated=true;var questions=inputQuestions.map(function(question){if(question.required&&question.answer===""){validated=false,question.error=true;}else if(question.type==="email"&&invalidEmail(question.answer,question.required)){validated=false,question.error=true;}else if(question.type==="tel"&&textboxUtil_invalidPhone(question.answer,question.required)){validated=false,question.error=true;}else{question.error=false;}return question;});setInputQuestions(questions);return validated;};/* If input errors are present, the input with the first error is focused */var focusFirstError=function focusFirstError(){var firstErrorIndex=inputQuestions.findIndex(function(question){return question.error;});if(firstErrorIndex>=0&&inputRefs[firstErrorIndex].current){inputRefs[firstErrorIndex].current.focus();}};return{inputQuestions:inputQuestions,setInputQuestions:setInputQuestions,newScreenInputs:newScreenInputs,inputsValidated:inputsValidated,focusFirstError:focusFirstError,inputRefs:inputRefs};}
...
// CONCATENATED MODULE: ./src/lib/hooks/useForm.js
/**
 * Custom hook that contains the state for a set of form values
 * @param {Object} initialFormState
 * @returns {Array}
 */function useForm(){var initialFormState=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var _useState=Object(react["useState"])(initialFormState),_useState2=_slicedToArray(_useState,2),data=_useState2[0],setData=_useState2[1];/**
   ...
   */var updateData=function updateData(modifyObj,additionalFields){setData(modifyObj.apply(void 0,[data].concat(_toConsumableArray(additionalFields))));};return[data,updateData];}
// CONCATENATED MODULE: ./src/lib/utils/checkboxUtil.js
var flattenCheckboxes=function flattenCheckboxes(checkedFields){return checkedFields?checkedFields.filter(function(_ref){var checked=_ref.checked;return checked;}).map(function(_ref2){var label=_ref2.label;return label;}):[];};
// CONCATENATED MODULE: ./src/lib/utils/formUtil.js
var setFeedbackType=function setFeedbackType(feedbackForAPI,text,feedbackID){var feedback=feedbackForAPI;feedback.feedbackType={label:text,feedbackID:feedbackID};return feedback;};var formUtil_processFeedback=function processFeedback(feedbackForAPI,checkedFields,inputQuestions){/* if formID is feedback, sets checkedOptions and inputResponses 
    in the feedbackForAPI object */var feedback=feedbackForAPI;/* filters checkedOptions for the fields that are checked,
        then returns only the label property */feedback.checkedOptions=flattenCheckboxes(checkedFields);feedback.inputResponses=flattenInputs(inputQuestions);feedback.source=window.location.href;return feedback;};var processUserInfo=function processUserInfo(userInfo,inputQuestions,endpoint){var userObj=userInfo;inputQuestions.forEach(function(_ref){var question=_ref.question,answer=_ref.answer;userObj[question]=answer;});userObj.source=window.location.href;userObj.id=endpoint;return userObj;};
...
function Header(_ref){var innerRef=_ref.innerRef;return/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{ref:innerRef}),/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["GridContainer"],{className:"feedback-header",children:/*#__PURE__*/Object(jsx_runtime["jsx"])("img",{className:"width-auto height-2 mobile-lg:height-205 mobile-lg-height-205",src:header_logo,alt:"New York City feedback module logo"})})]});}/* harmony default export */ var common_Header = (Header);
// CONCATENATED MODULE: ./src/components/common/Button.js
function ModuleButton(_ref){var buttonText=_ref.buttonText,onClick=_ref.onClick,isRight=_ref.isRight,className=_ref.className;return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Button"],{"aria-label":buttonText,onClick:onClick,className:"".concat(isRight&&"flex-align-self-end"," ").concat(className),type:"button",children:buttonText});}/* harmony default export */ var Button = (ModuleButton);
// CONCATENATED MODULE: ./src/components/common/Checkbox.js
function ModuleCheckbox(_ref){var label=_ref.label,id=_ref.id,onCheck=_ref.onCheck,firstCheckRef=_ref.firstCheckRef;// Sets checkbox to checked when user presses enter
var handleKeyDown=function handleKeyDown(e){if(e.key==="Enter"){onCheck();e.target.checked=!e.target.checked;}};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Checkbox"],{id:id,label:label,color:"primary",onChange:onCheck,onKeyDown:handleKeyDown,inputRef:firstCheckRef});}/* harmony default export */ var Checkbox = (ModuleCheckbox);
// CONCATENATED MODULE: ./src/components/common/Textbox.js
function Textbox(_ref){var id=_ref.id,type=_ref.type,label=_ref.label,className=_ref.className,onChange=_ref.onChange,required=_ref.required,describedBy=_ref.describedBy,invalid=_ref.invalid,inputRef=_ref.inputRef;return/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Label"],{className:className,htmlFor:id,children:"".concat(label).concat(required?"*":"")}),type==="textarea"?/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Textarea"],{id:id,name:label,onChange:onChange,"aria-invalid":invalid,"aria-describedby":invalid?describedBy:undefined,inputRef:inputRef}):/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["TextInput"],{id:id,name:label,type:type,className:className,onChange:onChange,"aria-invalid":invalid,"aria-describedby":invalid?describedBy:undefined,inputRef:inputRef})]});}/* harmony default export */ var common_Textbox = (Textbox);
// CONCATENATED MODULE: ./src/components/CheckboxList.js
function CheckboxList(_ref){var feedbackCheckboxes=_ref.feedbackCheckboxes,onCheck=_ref.onCheck,setOtherField=_ref.setOtherField,checkboxKey=_ref.checkboxKey,firstCheckRef=_ref.firstCheckRef;var _useTranslation=useTranslation(),i18n=_useTranslation.i18n;var en=i18n.getFixedT("en");var _useState=Object(react["useState"])(false),_useState2=_slicedToArray(_useState,2),otherChecked=_useState2[0],setOtherChecked=_useState2[1];var onCheckOther=function onCheckOther(index){en(checkboxKey)[index]==="Other"&&setOtherChecked(!otherChecked);onCheck(index);};var onChangeOther=function onChangeOther(_ref2){var target=_ref2.target;setOtherField(target.value);};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{children:feedbackCheckboxes.map(function(label,index){return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{row:true,className:"flex-no-wrap",children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(Checkbox,{id:"feedback-checkbox-".concat(index),label:label,onCheck:function onCheck(){return onCheckOther(index);},className:"width-full",firstCheckRef:index===0?firstCheckRef:undefined}),otherChecked&&en(checkboxKey)[index]==="Other"&&/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Textbox,{id:"other-field",type:"text",className:"margin-left-1",onChange:onChangeOther,label:""})]},index);})});}/* harmony default export */ var components_CheckboxList = (CheckboxList);
// EXTERNAL MODULE: ./node_modules/feather-icons-react/build/index.js
var build = __webpack_require__(26);
var build_default = /*#__PURE__*/__webpack_require__.n(build);

// CONCATENATED MODULE: ./src/components/common/ErrorAlert.js
function ErrorAlert(_ref){var errorText=_ref.errorText,dir=_ref.dir,id=_ref.id;return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Alert"],{type:"error",slim:true,noIcon:true,wrapper:"span",id:id,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(build_default.a,{icon:"alert-triangle",size:"22",strokeWidth:"2.5",className:"".concat(dir==="rtl"?"margin-left-205":"margin-right-205"," padding-top-2px")}),errorText]});}/* harmony default export */ var common_ErrorAlert = (ErrorAlert);
// CONCATENATED MODULE: ./src/components/TextboxList.js
function TextboxList(_ref){var inputs=_ref.inputs,inputQuestions=_ref.inputQuestions,setInputQuestions=_ref.setInputQuestions,className=_ref.className,inputRefs=_ref.inputRefs;var _useTranslation=useTranslation(),t=_useTranslation.t;// Curried onChange funtion: returns a new function binded with the index
var onChange=function onChange(index){return function(_ref2){var target=_ref2.target;var answers=inputQuestions;answers[index].answer=target.value;setInputQuestions(answers);};};var inputError=function inputError(input,id){var key;if(input.type==="tel"){key="phoneError";}else if(input.type==="email"){key="emailError";}else if(input.text==="Your name"){key="nameError";}else if(input.type==="textarea"||input.type==="text"){key="inputEmptyError";}if(!key)return;return/*#__PURE__*/Object(jsx_runtime["jsx"])(common_ErrorAlert,{errorText:t("errorMessages.".concat(key)),id:id},key);};var isInvalid=function isInvalid(index){return inputQuestions&&inputQuestions[index]&&inputQuestions[index].error;};var showErrors=function showErrors(input,index){if(isInvalid(index)){return inputError(input,"feedback-input-error-".concat(index));}};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{children:inputs.map(function(input,index){return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{col:"fill",className:"".concat(className," padding-y-2 mobile:padding-y-").concat(input.type==="textarea"?4:3),children:[showErrors(input,index),/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Textbox,{id:"feedback-input-".concat(index),type:input.type,label:input.text,onChange:onChange(index),required:input.required,invalid:isInvalid(index),describedBy:"feedback-input-error-".concat(index),inputRef:inputRefs[index]})]},index);})});}/* harmony default export */ var components_TextboxList = (TextboxList);
// CONCATENATED MODULE: ./src/components/LightContainer.js
function LightContainer(_ref){var children=_ref.children,formID=_ref.formID;var isChildNull=function isChildNull(children){/* returns true if there are no elements outside of the form element
         and the form is empty */return!(react_default.a.Children.toArray(children).length>1||formID);};return isChildNull(children)?children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{className:"feedback-screen-container",children:children});}/* harmony default export */ var components_LightContainer = (LightContainer);
// CONCATENATED MODULE: ./src/components/Module.js
function Module(_ref){var pagetitle=_ref.pagetitle,endpoint=_ref.endpoint,dir=_ref.dir;var _useForm=useForm({}),_useForm2=_slicedToArray(_useForm,2),feedbackForAPI=_useForm2[0],updateFeedbackForAPI=_useForm2[1];var _useForm3=useForm({}),_useForm4=_slicedToArray(_useForm3,2),userInfo=_useForm4[0],updateUserInfo=_useForm4[1];var _useState=Object(react["useState"])(INITIAL_SCREEN),_useState2=_slicedToArray(_useState,2),screen=_useState2[0],setScreen=_useState2[1];var _useState3=Object(react["useState"])(false),_useState4=_slicedToArray(_useState3,2),checkboxError=_useState4[0],setCheckboxError=_useState4[1];// Methods and variables for accessing the state of the checkbox fields
var _useCheckboxes=useCheckboxes(),checkedFields=_useCheckboxes.checkedFields,_onCheck=_useCheckboxes.onCheck,newScreenCheckboxes=_useCheckboxes.newScreenCheckboxes,checkboxValidated=_useCheckboxes.checkboxValidated,updateOtherField=_useCheckboxes.updateOtherField,setOtherField=_useCheckboxes.setOtherField;var headerRef=Object(react["useRef"])(null);var firstCheckRef=Object(react["useRef"])(null);// Methods and variables for accessing the state of the input fields
var _useInputs=useInputs(firstCheckRef),inputQuestions=_useInputs.inputQuestions,setInputQuestions=_useInputs.setInputQuestions,newScreenInputs=_useInputs.newScreenInputs,inputsValidated=_useInputs.inputsValidated,focusFirstError=_useInputs.focusFirstError,inputRefs=_useInputs.inputRefs;var _useTranslation=useTranslation(),t=_useTranslation.t,i18n=_useTranslation.i18n;var en=i18n.getFixedT("en");var _googleAnalytics=googleAnalytics(),trackFutureResearch=_googleAnalytics.trackFutureResearch,pageTitleAsScreen=_googleAnalytics.pageTitleAsScreen,pageChange=_googleAnalytics.pageChange,moduleOnScreen=_googleAnalytics.moduleOnScreen;var moduleVisibleRef=Object(react["useRef"])();Object(react["useEffect"])(function(){// Updates the checkboxes based on the new screen
newScreenCheckboxes(screen.checkboxes);newScreenInputs(screen.textInputs);if(firstCheckRef.current){firstCheckRef.current.focus();}},[screen]);// sendFormData determines which form data state to update, based on the formID
var sendFormData=function sendFormData(formID){if(formID==="feedback"){updateFeedbackForAPI(formUtil_processFeedback,[checkedFields,inputQuestions]);services_requestService("feedback",{id:endpoint,feedback:feedbackForAPI});console.log(feedbackForAPI);}else if(formID==="research"){trackFutureResearch();updateUserInfo(processUserInfo,[inputQuestions,endpoint]);services_requestService("userResearch",userInfo);console.log(userInfo);}};var submitForm=function submitForm(nextScreen){// Submit form data if this screen contains a form
// Make sure all checkboxes are checked if they exist on this page
if(screen.checkboxes&&screen.checkboxes.required&&!checkboxValidated(checkedFields)){setCheckboxError(true);firstCheckRef.current&&firstCheckRef.current.focus();// Make sure all required fields are completed
}else if(screen.textInputs&&!inputsValidated()){focusFirstError();}else{updateOtherField();var currentPageTitle=en(screen.title)?en(screen.title,{page:pagetitle}):en(screen.titleInverse,{page:pagetitle});var nextPageTitle=en(SCREENS[nextScreen].title)?en(SCREENS[nextScreen].title,{page:pagetitle}):en(SCREENS[nextScreen].titleInverse,{page:pagetitle});pageTitleAsScreen(currentPageTitle);pageChange(currentPageTitle,nextPageTitle);sendFormData(screen.formID),setScreen(SCREENS[nextScreen]),setCheckboxError(false);}};var handleSubmit=function handleSubmit(e){e.preventDefault();};var changeScreen=function changeScreen(text,nextScreen,feedbackID){// If button contains a feedbackID, update the feedbackType of the feedback object
if(screen.formID){submitForm(nextScreen);}else{feedbackID&&updateFeedbackForAPI(setFeedbackType,[en(text),feedbackID]);setScreen(SCREENS[nextScreen]);setCheckboxError(false);var currentPageTitle=en(screen.title)?en(screen.title,{page:pagetitle}):en(screen.titleInverse,{page:pagetitle});var nextPageTitle=en(SCREENS[nextScreen].title)?en(SCREENS[nextScreen].title,{page:pagetitle}):en(SCREENS[nextScreen].titleInverse,{page:pagetitle});pageTitleAsScreen(currentPageTitle);pageChange(currentPageTitle,nextPageTitle);}headerRef.current.scrollIntoView(true);};return/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{ref:moduleVisibleRef,children:/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["GridContainer"],{desktop:{col:2},mobile:{col:"fill"},className:"feedback-module-container",dir:dir,children:[moduleOnScreen(moduleVisibleRef),/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Header,{innerRef:headerRef}),screen.titleInverse&&/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{className:"bg-primary feedback-screen-container",children:/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{className:"font-sans-md2 feedback-h1 feedback-h1--light",dangerouslySetInnerHTML:{__html:t(screen.titleInverse)}})}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(components_LightContainer,{formID:screen.formID,children:[screen.title&&/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{className:"font-sans-md2 feedback-h1 feedback-h1--dark",children:"".concat(t(screen.title,{page:pagetitle})).concat(screen.checkboxes&&screen.checkboxes.required?"*":"")}),screen.plainText&&/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"font-sans-md feedback-plaintext",dangerouslySetInnerHTML:{__html:t(screen.plainText)}}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Form"],{onSubmit:handleSubmit,children:[screen.checkboxes&&t(screen.checkboxes.labels)&&/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[checkboxError&&/*#__PURE__*/Object(jsx_runtime["jsx"])(common_ErrorAlert,{errorText:t("errorMessages.checkboxError"),dir:dir}),/*#__PURE__*/Object(jsx_runtime["jsx"])(components_CheckboxList,{feedbackCheckboxes:t(screen.checkboxes.labels),onCheck:function onCheck(index){return _onCheck(index);},setOtherField:setOtherField,checkboxKey:screen.checkboxes.labels,firstCheckRef:firstCheckRef})]}),screen.textInputs&&t(screen.textInputs)&&/*#__PURE__*/Object(jsx_runtime["jsx"])(components_TextboxList,{inputs:t(screen.textInputs),setInputQuestions:setInputQuestions,inputQuestions:inputQuestions,inputRefs:inputRefs}),screen.buttons&&screen.buttons.map(function(_ref2,index){var type=_ref2.type,text=_ref2.text,nextScreen=_ref2.nextScreen,feedbackID=_ref2.feedbackID;return/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:t(text),isRight:type==="submit",onClick:function onClick(){return changeScreen(text,nextScreen,feedbackID);}},index);})]})]})]})});}/* harmony default export */ var components_Module = (Module);
// CONCATENATED MODULE: ./src/App.js
/* eslint-disable no-unused-vars */function App(_ref){var pagetitle=_ref.pagetitle,lang=_ref.lang,endpoint=_ref.endpoint;var _useTranslation=useTranslation(),i18n=_useTranslation.i18n;Object(react["useEffect"])(function(){i18n.changeLanguage(lang);},[lang]);return/*#__PURE__*/Object(jsx_runtime["jsxs"])(x,{children:[ true&&/*#__PURE__*/Object(jsx_runtime["jsx"])(N,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])("link",{rel:"stylesheet",href:"/main.css"})}),/*#__PURE__*/Object(jsx_runtime["jsx"])(components_Module,{pagetitle:pagetitle,endpoint:endpoint,dir:i18n.dir(i18n.language)})]});}/* harmony default export */ var src_App = (App);
// CONCATENATED MODULE: ./src/index.js
var WidgetDivs=document.querySelectorAll("#feedback-widget");var src_renderApp=function renderApp(Div,lang,pagetitle,endpoint){Div.attributes.lang&&(lang=Div.attributes.lang.value);Div.attributes.pagetitle&&(pagetitle=Div.attributes.pagetitle.value);Div.attributes.endpoint&&(endpoint=Div.attributes.endpoint.value);react_dom_default.a.render(/*#__PURE__*/Object(jsx_runtime["jsx"])(react_default.a.StrictMode,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react["Suspense"],{fallback:"... is loading",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(src_App,{domElement:Div,lang:lang,pagetitle:pagetitle,endpoint:endpoint})})}),Div);};WidgetDivs.forEach(function(Div){var currentLang="en";var pagetitle="";var endpoint="";var gaid="";Div.attributes.gaid&&(gaid=Div.attributes.gaid.value);var ga4react=new ga_4_react_esm(gaid);_asyncToGenerator(/*#__PURE__*/regenerator_default.a.mark(function _callee(){return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return ga4react.initialize().then(function(res){return console.log("Analytics Success: ".concat(res));}).catch(function(err){return console.log("Analytics Failure: ".concat(err));}).finally(function(){src_renderApp(Div,currentLang,pagetitle,endpoint);var observer=new MutationObserver(function(mutations){mutations.forEach(function(mutation){if(mutation.type=="attributes"){src_renderApp(Div,currentLang,pagetitle,endpoint);}});});observer.observe(Div,{attributes:true});});case 2:case"end":return _context.stop();}}},_callee);}))();});// If you want to start measuring performance in your app, pass a function
